...
const FoodElement = ({ product }) => {
  return (
    <div className="relative mx-auto flex h-[17rem] w-52 items-end justify-start sm:h-[17rem] sm:w-52 md:h-80 md:w-60 lg:h-[20rem] lg:w-60 xl:h-[23rem] xl:w-64">
      <div className="absolute right-0 top-0 overflow-hidden rounded-full border-[12px] border-rose-400 text-[15rem]">
        <img
          src={product?.image}
          alt={product?.name}
